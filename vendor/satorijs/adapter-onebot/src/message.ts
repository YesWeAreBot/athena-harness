...
export class OneBotMessageEncoder extends MessageEncoder<OneBotBot> {
  ...
  override async prepare(): Promise<void> {
    ...
    if (!channel!.type) {
      channel!.type = channel!.id.startsWith(PRIVATE_PFX) ? Universal.Channel.Type.DIRECT : Universal.Channel.Type.TEXT;
    }
