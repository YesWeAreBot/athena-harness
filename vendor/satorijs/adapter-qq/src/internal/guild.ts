...
declare module "./internal" {
  interface GuildInternal {
    ...
    createGuildRole(
      guild_id: string,
      params: QQ.CreateGuildRoleParams,
    ): Promise<{
      role_id: string;
      role: QQ.Role;
    }>;
    ...
    modifyChannelMemberPermissions(
      channel_id: string,
      user_id: string,
      params: {
        add: string;
    ...
    createDMS(data: { recipient_id: string; source_guild_id: string }): Promise<QQ.DMS>;
    deleteDM(
      guildId: string,
      messageId: string,
      params?: {
    ...
    createPost(
      channelId: string,
      data: QQ.Forum.CreatePostRequest,
    ): Promise<{
      task_id: string;
      create_time: string;
    }>;
