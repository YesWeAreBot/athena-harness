...
function isTestFrameworkObject(sourceCode: SourceCode, expression: ESTree.Expression): expression is ESTree.IdentifierReference {
...
function moduleMockCall(sourceCode: SourceCode, callee: ESTree.Expression): boolean {
  ...
  const method = callee.computed
    ? property.type === "Literal" && (property.value === "doMock" || property.value === "mock" || property.value === "unstable_mockModule")
      ? property.value
      : null
