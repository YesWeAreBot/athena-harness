...
export interface Internal {
  ...
  getGuildMetaByGuest(guild_id: id): Promise<any>;
  getGuildChannelList(guild_id: id, no_cache: boolean): Promise<ChannelInfo[]>;
  getGuildMemberList(guild_id: id, next_token?: string): Promise<any>;
  getGuildMemberProfile(guild_id: id, user_id: id): Promise<any>;
...
export class Internal {
  ...
  constructor(public readonly bot: OneBotBot) {}

  private get logger() {
    return this.bot.ctx.logger("onebot");
  }
